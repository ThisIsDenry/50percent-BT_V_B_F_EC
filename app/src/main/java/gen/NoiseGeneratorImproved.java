...
public class NoiseGeneratorImproved {
   ...
   public NoiseGeneratorImproved(ChunkRand chunkRand) {
      this.xCoord = chunkRand.nextDouble() * 256.0D;
      this.yCoord = chunkRand.nextDouble() * 256.0D;
      this.zCoord = chunkRand.nextDouble() * 256.0D;
      ...
      for(int l = 0; l < 256; ++l) {
         int j = chunkRand.nextInt(256 - l) + l;
